 ...
 * 
 * path: accountOptimizer/all/widget/widget_21.js 
 * desc: 账户优化子项详情，连通速度优化
 * author: wanghuijun@baidu.com
 * date: $Date: 2011/07/26 $
 */

ao.widget21 = new er.Action({
    /**
     * 视图模板名，或返回视图模板名的函数
     */
    VIEW: 'widgetDetail21',
    ...
    CONTEXT_INITER_MAP: {
		...
		init : function(callback) {
			...
			me.setContext('widget_link', HOLMES_HOMEPAGE_URL);
			me.setContext('opttype', 21);
		...
		widgetTable : function(callback) {
			var me = this,
				tabFields = [{
					...
					title: '以下推广页面打开速度需要优化',
					breakLine: true,
					width: 400
				}, {
					content: me.colRender.loadtime,
					title: '打开速度',
					breakLine: true,
					align: 'right',
					width: 100
